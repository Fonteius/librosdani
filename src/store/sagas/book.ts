...
export function* publishBookSaga(action: any): Generator<any, any, any> {
...
export function* publishPicturesSaga(files: any): Generator<any, any, any> {
...
export function* updateBookSaga(action: any): Generator<any, any, any> {
...
export function* removeBookSaga(action: any): Generator<any, any, any> {
...
export function* fetchBooksSaga(action: any): Generator<any, any, any> {
...
export function* fetchBookSaga(action: any): Generator<any, any, any> {
