...
import { isAuthenticatedSelector, authSelector } from 'src/store/rootSelector';
import {
	AppBar,
	Toolbar,
	makeStyles,
...
const MainMenu = (props: any) => {
	...
	const { username, email, avatar } = useSelector(authSelector);
	...
	const listKeyDownHandler = (e: any) => {
		if (e.key === 'Tab') {
			e.preventDefault();
			setMenuOpen(false);
		}
	...
	const tabsChangeHandler = (e: any, newValue: any) => {
	...
	if (isAuthenticated) {
		...
		authLinks = (
			<Fragment>
				<Button
					ref={menuAnchorRef}
					aria-controls={menuOpen ? 'menuListGrow' : ''}
					aria-haspopup='true'
